...
namespace Demo.Controllers
{
    public class HotelController : ApiController
    {
        ...
        public List<string> Gethotels(double lat,double longi)
        {
           ...
           string Url = "https://maps.googleapis.com/maps/api/place/nearbysearch/xml?location="+latString+","+longiString+"&radius=1500&type=restaurant&keyword=cruise&key=AIzaSyCEYBTJaRPGz2e-wq-u3aoEOTI6w-DtQ7A";
